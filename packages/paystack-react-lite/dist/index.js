...
function usePaystackScript() {
    const [ready, setReady] = require$$0.useState(false);
    require$$0.useEffect(() => {
...
const PaystackContext = require$$0.createContext(null);
function PaystackProvider({ publicKey, children, }) {
    return (jsxRuntimeExports.jsx(PaystackContext.Provider, { value: { publicKey }, children: children }));
}
function usePaystackPublicKey() {
    const context = require$$0.useContext(PaystackContext);
    if (!context) {
...
exports.usePaystackPublicKey = usePaystackPublicKey;
